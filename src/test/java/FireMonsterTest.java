...
public class FireMonsterTest {
  ...
  public void all_returnsAllInstancesOfFireMonster_true() {
    ...
    FireMonster secondFireMonster = new FireMonster("Sparkles", 1);
  ...
  @Test
  public void fireMonster_instantiatesWithHalfFoodPlayLevel() {
    FireMonster testFireMonster = new FireMonster("Bubbles", 1);
  ...
  @Test
  public void play_increasedFireMonsterPlayLevel() {
    FireMonster testFireMonster = new FireMonster("Bubbles", 1);
  ...
  @Test
  public void sleep_increasedFireMonsterSleepLevel() {
    FireMonster testFireMonster = new FireMonster("Bubbles", 1);
  ...
  @Test
  public void feed_increasedFireMonsterFoodLevel() {
    FireMonster testFireMonster = new FireMonster("Bubbles", 1);
  ...
  @Test
  public void FireMonster_foodLevelCannotIncreaseBeyondMaxValue() {
    FireMonster testFireMonster = new FireMonster("Bubbles", 1);
    for(int i = FireMonster.MIN_ALL_LEVELS; i <= (FireMonster.MAX_FOOD_LEVEL); i++) {
      try {
        testFireMonster.feed();
  ...
  @Test(expected = UnsupportedOperationException.class)
   ...
   @Test
   public void fireMonster_playLevelCannotIncreaseBeyondMaxValue() {
     FireMonster testFireMonster = new FireMonster("Bubbles", 1);
   ...
   @Test
   public void FireMonster_sleepLevelCannotIncreaseBeyondMaxValue() {
     FireMonster testFireMonster = new FireMonster("Bubbles", 1);
   ...
   @Test
   public void kindling_recordsTimeLastKindledInDatabase() {
     FireMonster testFireMonster = new FireMonster("Smokey", 1);
     testFireMonster.save();
     testFireMonster.kindling();
