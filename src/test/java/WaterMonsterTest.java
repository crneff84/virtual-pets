...
public class WaterMonsterTest {
  ...
  public void all_returnsAllInstancesOfWaterMonster_true() {
    ...
    WaterMonster secondWaterMonster = new WaterMonster("Sparkles", 1);
  ...
  @Test
  public void save_savesWaterMonsterWithPersonIdIntoDB_true() {
  ...
  @Test
  public void waterMonster_instantiatesWithHalfFoodPlayLevel() {
    WaterMonster testWaterMonster = new WaterMonster("Bubbles", 1);
  ...
  @Test
  public void play_increasedWaterMonsterPlayLevel() {
    WaterMonster testWaterMonster = new WaterMonster("Bubbles", 1);
  ...
  @Test
  public void sleep_increasedWaterMonsterSleepLevel() {
    WaterMonster testWaterMonster = new WaterMonster("Bubbles", 1);
  ...
  @Test
  public void feed_increasedWaterMonsterFoodLevel() {
    WaterMonster testWaterMonster = new WaterMonster("Bubbles", 1);
  ...
  @Test
  public void WaterMonster_foodLevelCannotIncreaseBeyondMaxValue() {
    WaterMonster testWaterMonster = new WaterMonster("Bubbles", 1);
    for(int i = WaterMonster.MIN_ALL_LEVELS; i <= (WaterMonster.MAX_FOOD_LEVEL); i++) {
      try {
        testWaterMonster.feed();
  ...
  @Test(expected = UnsupportedOperationException.class)
   ...
   @Test
   public void waterMonster_playLevelCannotIncreaseBeyondMaxValue() {
     WaterMonster testWaterMonster = new WaterMonster("Bubbles", 1);
   ...
   @Test
   public void WaterMonster_sleepLevelCannotIncreaseBeyondMaxValue() {
     WaterMonster testWaterMonster = new WaterMonster("Bubbles", 1);
   ...
   public void water_increasesWaterMonsterWaterLevel() {
     WaterMonster testWaterMonster = new WaterMonster("Smokey", 1);
